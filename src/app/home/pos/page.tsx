...
// UPDATE dari src/app/pos/page.tsx:
// - Path pindah ke /home/pos
// - Tampilkan stok pada filter kategori (stok menipis)
...
export default function POSPage() {
  ...
  useEffect(() => {
    ...
    // Subscribe perubahan menu — kalau admin ubah stok/ketersediaan, langsung update di POS
  ...
  return (
    // h-[calc(100vh-49px)]: kurangi tinggi header dari HomeLayout
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="px-4 pt-4 pb-3 bg-gray-900 border-b border-gray-800">
          <div className="flex justify-between mb-3">
            <h2 className="font-bold text-base">Pilih Menu</h2>
            <input
              placeholder="Cari menu..."
              value={search}
              onChange={e => setSearch(e.target.value)}
              className="bg-gray-800 border border-gray-700 rounded-lg px-3 py-2
                text-sm w-44 focus:outline-none focus:border-orange-500"
            />
          </div>
